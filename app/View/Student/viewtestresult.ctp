                      ...
                      <table class="no-style full" cellpadding="0" cellspacing="0" border="0">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <span style="font-weight: bold"><a href="javascript:showQuesSec(0);" style="font-family:Trebuchet MS; font-size:13px; color:#484848; text-decoration:none;">View do test</a> 
                            | <a href="#" style="font-family:Trebuchet MS; font-size:13px; color:#484848; text-decoration:none;">View Lesson</a>
                            | <a href="#" style="font-family:Trebuchet MS; font-size:13px; color:#484848; text-decoration:none;">Take Next Text</a></span>
                            </td>
                          </tr>
                        </tbody>
                      </table>
