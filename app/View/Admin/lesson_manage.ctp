...
<div class = "input-group col-md-8">
	...
	<input type = "text" id = "search-input" class = "form-control" placeholder = "<?php echo __('Search');?>">
</div>
<p></p>
<div class="row col-md-12">
	<table class="table table-bordered table-hover">
		...
		foreach ($lessons as $d):                
			echo '<tr class="linktr data-row">'.
					'<td>'.
						$this->Html->link($d['Lesson']['name'],array(
							'controller' => 'Lesson',
							'action' =>'index',
							$d['Lesson']['coma_id'] )).
					'</td>'.
					'<td class="search-data">'
						.$d['Author']['username']
					.'</td>';
			echo '<td class="search-data" style="display:none">'.$d['Lesson']['name'].'</td>';
