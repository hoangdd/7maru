...
Configure::write('userRoles', array(
	...
	'R2' => array(
		'file' => '*',
		'home' => '*',
		'lesson' => array('index','view', 'comment', 'create', 'edit', 'destroy', 'recentlesson','viewcontent','testhistory','exam','dotest','result','viewtestresult','addcategory'),
		'login' => '*',
		'reference' => '*',
		'search' => '*',
		'user' => '*',
...
Configure::write('command', array(
	'pdf2swf' => array(
		'pdf2swf %s -o %s -f -T 9 -t -s storeallcharacters'
		),
